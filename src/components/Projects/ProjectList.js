...
export const projectList = [
    {
        ...
        image: Proj1,
        description : "A static university admission website using HTML CSS Javascript", 
    ...
    },
    {
        name:"Pricing Plans",
        image: Proj2,
        description : "A Static pricing list website using HTML and Tailwind CSS",
    ...
    },
    {
        ...
        links: <div className='icons'><a href='' target="_blank" ><FaGlobe className="globe" /></a>  <a href='' target="_blank" className="git"><FaGithub /></a></div>
    },
    {
        name:"Memory Match",
        image: Proj7,
        description: "A Memory game using React",
        links: <div className='icons'><a href='https://photo-gallery-peach.vercel.app/' target="_blank" ><FaGlobe className="globe" /></a>  <a href='https://github.com/AbhinabaDe01/photo-gallery' target="_blank" className="git"><FaGithub /></a></div>
    },
    {
