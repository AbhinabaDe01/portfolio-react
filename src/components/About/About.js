    ...
    <div className='a' id='about'>
        <div className='a-left'  style={{backgroundColor: darkMode && "#333"}}>
            <div className='a-left-wrapper'>
                ...
                <div><b>Skills: </b>
                <p>Learning Web development. Happily Learning new skills and ready to learn more always!!</p>
                <div>Current skills are <b>HTML</b>, <b>CSS</b>, <b>Bootstrap</b>, <b>TailwindCSS</b>, <b>Javascript</b>, <b>Jquery</b> and <b>React</b> framework. Also got my hands on <b>Figma</b> and bit of UI/UX designing.</div>
                </div>
                <div className='btn-wrapper'><button className='btn'>Download Resume</button></div>
            </div>
